...
<head>
    ...
    <link href="{{url('')}}/assets/public/assets/vendor/owl-carousel/owl.carousel.css" rel="stylesheet"
        type="text/css" />

    <link href="{{url('')}}/assets/public/assets/vendor/nouislider/nouislider.min.css" rel="stylesheet"
        type="text/css" />
                                ...
                                <ul class="contacts">
                                    ...
                                    <li class="active dlab-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{url('')}}/assets/public/assets/images/avatar/1.jpg"
                                    ...
                                    <li class="dlab-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{url('')}}/assets/public/assets/images/avatar/2.jpg"
                                                    class="rounded-circle user_img" alt="">
                                    ...
                                    <li class="dlab-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{url('')}}/assets/public/assets/images/avatar/3.jpg"
                                                    class="rounded-circle user_img" alt="">
                                                <span class="online_icon"></span>
                                            </div>
                                            <div class="user_info">
                                    ...
                                    <li class="dlab-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{url('')}}/assets/public/assets/images/avatar/4.jpg"
                                                    class="rounded-circle user_img" alt="">
                                                <span class="online_icon offline"></span>
                                            </div>
                                            <div class="user_info">
                                    ...
                                    <li class="dlab-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{url('')}}/assets/public/assets/images/avatar/5.jpg"
                                                    class="rounded-circle user_img" alt="">
                                                <span class="online_icon offline"></span>
                                            </div>
                                            <div class="user_info">
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a class="has-arrow" href="{{ route('user.services') }}" aria-expanded="false">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li class="sidebar-menu-item {{ menuActive('user.order.mass') }}">
                                <a class="" href="{{ route('user.order.mass') }}">
                    ...
                    <li><a class="" href="{{ route('user.deposit.history') }}" aria-expanded="false">
                            <i class="fas fa-wallet"></i>
                            <span class="nav-text">Fund Wallet</span>
                        </a>
                    </li>
                    <li><a class=" " href="{{ route('user.transactions') }}" aria-expanded="false">
                    ...
                    <li><a class=" " href="{{ route('user.api.index') }}" aria-expanded="false">
                            <i class="fa fa-cloud"></i>
                            <span class="nav-text">API</span>
                        </a>

                    <li><a class=" " href="{{ route('ticket.index') }}" aria-expanded="false">
                            <i class="fa fa-ticket"></i>
                            <span class="nav-text">Ticket</span>
                        </a>

                    <li><a class=" " href="{{ route('user.twofactor') }}" aria-expanded="false">
...
***********************************-->
    ...
    <script src="{{url('')}}/assets/public/assets/vendor/counter/counter.min.js"></script>
    <script src="{{url('')}}/assets/public/assets/vendor/counter/waypoint.min.js"></script>
    <script src="{{url('')}}/assets/public/assets/vendor/apexchart/apexchart.js"></script>
    <script src="{{url('')}}/assets/public/assets/vendor/chart-js/chart.bundle.min.js"></script>
    <script src="{{url('')}}/assets/public/assets/vendor/peity/jquery.peity.min.js"></script>
    <script src="{{url('')}}/assets/public/assets/js/dashboard/dashboard-1.js"></script>
    <script src="{{url('')}}/assets/public/assets/vendor/owl-carousel/owl.carousel.js"></script>
