...
<head>
    ...
    <link href="<?php echo e(url('')); ?>/assets/public/assets/vendor/owl-carousel/owl.carousel.css" rel="stylesheet"
        type="text/css" />

    <link href="<?php echo e(url('')); ?>/assets/public/assets/vendor/nouislider/nouislider.min.css" rel="stylesheet"
        type="text/css" />
        ...
        <div class="chatbox">
            ...
            <div class="custom-tab-1">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="index_2.html#notes">Notes</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="index_2.html#alerts">Alerts</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" data-bs-toggle="tab" href="index_2.html#chat">Chat</a>
                    </li>
                </ul>
                                ...
                                <ul class="contacts">
                                    ...
                                    <li class="active dlab-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="<?php echo e(url('')); ?>/assets/public/assets/images/avatar/1.jpg"
                                    ...
                                    <li class="dlab-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="<?php echo e(url('')); ?>/assets/public/assets/images/avatar/2.jpg"
                                                    class="rounded-circle user_img" alt="">
                                    ...
                                    <li class="dlab-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="<?php echo e(url('')); ?>/assets/public/assets/images/avatar/3.jpg"
                                                    class="rounded-circle user_img" alt="">
                                                <span class="online_icon"></span>
                                            </div>
                                            <div class="user_info">
                                    ...
                                    <li class="dlab-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="<?php echo e(url('')); ?>/assets/public/assets/images/avatar/4.jpg"
                                                    class="rounded-circle user_img" alt="">
                                                <span class="online_icon offline"></span>
                                            </div>
                                            <div class="user_info">
                                    ...
                                    <li class="dlab-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="<?php echo e(url('')); ?>/assets/public/assets/images/avatar/5.jpg"
                                                    class="rounded-circle user_img" alt="">
                                                <span class="online_icon offline"></span>
                                            </div>
                                            <div class="user_info">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown  header-profile">
                                <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                                    <img src="<?php echo e(url('')); ?>/assets/public/assets/images/avatar/1.png" width="56" alt="">
                                </a>
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a href="<?php echo e(route('user.profile.setting')); ?>" class="dropdown-item ai-icon">
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a class="has-arrow" href="<?php echo e(route('user.services')); ?>" aria-expanded="false">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li class="sidebar-menu-item <?php echo e(menuActive('user.order.mass')); ?>">
                                <a class="" href="<?php echo e(route('user.order.mass')); ?>">
                    ...
                    <li><a class="" href="<?php echo e(route('user.deposit.history')); ?>" aria-expanded="false">
                            <i class="fas fa-wallet"></i>
                            <span class="nav-text">Fund Wallet</span>
                        </a>
                    </li>
                    <li><a class=" " href="<?php echo e(route('user.transactions')); ?>" aria-expanded="false">
                    ...
                    <li><a class=" " href="<?php echo e(route('user.api.index')); ?>" aria-expanded="false">
                            <i class="fa fa-cloud"></i>
                            <span class="nav-text">API</span>
                        </a>

                    <li><a class=" " href="<?php echo e(route('ticket.index')); ?>" aria-expanded="false">
                            <i class="fa fa-ticket"></i>
                            <span class="nav-text">Ticket</span>
                        </a>

                    <li><a class=" " href="<?php echo e(route('user.twofactor')); ?>" aria-expanded="false">
                ...
                <div class="copyright">
                    <p>PALASH SMM © 2024 All Rights Reserved</p>
...
***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>PALASH SMM © 2024 All Rights Reserved <a href="https://bplux.store">Designed by Teetech</a></p>
            </div>
        </div>
        <!--**********************************
    Footer end
***********************************-->
    ...
    <script src="<?php echo e(url('')); ?>/assets/public/assets/vendor/counter/counter.min.js"></script>
    <script src="<?php echo e(url('')); ?>/assets/public/assets/vendor/counter/waypoint.min.js"></script>
    <script src="<?php echo e(url('')); ?>/assets/public/assets/vendor/apexchart/apexchart.js"></script>
    <script src="<?php echo e(url('')); ?>/assets/public/assets/vendor/chart-js/chart.bundle.min.js"></script>
    <script src="<?php echo e(url('')); ?>/assets/public/assets/vendor/peity/jquery.peity.min.js"></script>
    <script src="<?php echo e(url('')); ?>/assets/public/assets/js/dashboard/dashboard-1.js"></script>
    <script src="<?php echo e(url('')); ?>/assets/public/assets/vendor/owl-carousel/owl.carousel.js"></script>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/smm/core/resources/views/templates/basic/layouts/mainuser.blade.php ENDPATH**/ ?>