                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <div class="form-group">
                                    <label><?php echo app('translator')->get('Service ID'); ?></label>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/smm/core/resources/views/admin/service/add.blade.php ENDPATH**/ ?>